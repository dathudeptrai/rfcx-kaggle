...
def ResNet50V2(
    ...
    def stack_fn(x):
        x = resnet.stack2(x, 64, 3, use_mixstyle=use_mixstyle, name="conv2")
        x = resnet.stack2(x, 128, 4, use_mixstyle=use_mixstyle, name="conv3")
        x = resnet.stack2(x, 256, 6, use_mixstyle=False, name="conv4")
        return resnet.stack2(x, 512, 3, stride1=1, use_mixstyle=False, name="conv5")
...
def ResNet101V2(
    ...
    def stack_fn(x):
        x = resnet.stack2(x, 64, 3, use_mixstyle=use_mixstyle, name="conv2")
        x = resnet.stack2(x, 128, 4, use_mixstyle=use_mixstyle, name="conv3")
        x = resnet.stack2(x, 256, 23, use_mixstyle=use_mixstyle, name="conv4")
        return resnet.stack2(x, 512, 3, stride1=1, use_mixstyle=False, name="conv5")
...
def ResNet152V2(
    ...
    def stack_fn(x):
        x = resnet.stack2(x, 64, 3, use_mixstyle=use_mixstyle, name="conv2")
        x = resnet.stack2(x, 128, 8, use_mixstyle=use_mixstyle, name="conv3")
        x = resnet.stack2(x, 256, 36, use_mixstyle=use_mixstyle, name="conv4")
        return resnet.stack2(x, 512, 3, stride1=1, use_mixstyle=False, name="conv5")
