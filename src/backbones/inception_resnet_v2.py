...
def InceptionResNetV2(
    ...
    **kwargs,
    ...
    for block_idx in range(1, 11):
        ...
        if use_mixstyle:
            x = MixStyle(p=0.5, alpha=0.1, name=f"block35_{block_idx}_mixstyle")(x)
    ...
    for block_idx in range(1, 21):
        ...
        if use_mixstyle:
            x = MixStyle(p=0.5, alpha=0.1, name=f"block17_{block_idx}_mixstyle")(x)
    ...
    for block_idx in range(1, 10):
        ...
        if use_mixstyle:
            x = MixStyle(p=0.5, alpha=0.1, name=f"block8_{block_idx}_mixstyle")(x)
    x = inception_resnet_block(
